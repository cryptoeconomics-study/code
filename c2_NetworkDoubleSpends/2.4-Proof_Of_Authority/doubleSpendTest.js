...
// Broadcast the txs to the network
nodes[0].network.broadcastTo(nodes[0].pid, authority, spends[0])
nodes[0].network.broadcastTo(nodes[0].pid, authority, spends[1])
