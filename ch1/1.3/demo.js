...
console.log(
  "Since the fee is smaller than the extra 10 tokens Alice sent, she sends a cancelation transaction to Paypal and gets her tokens back"
);
// note: nonces are zero indexed, so they start at 0, then 1, then 2, etc...
const aliceTx2Cancellation = "TODO";
// TODO: make paymal process aliceTx2Cancellation
